...
function Klub_init() {
	register_post_type( 'Klub', array(
		'labels'            => array(
			...
			'all_items'           => __( 'Wszystkie Klub', 'mks' ),
			'new_item'            => __( 'Nowy wpis Klub', 'mks' ),
			'add_new'             => __( 'Dodaj nowy', 'mks' ),
			'add_new_item'        => __( 'DOdaj nowy do Klub', 'mks' ),
			'edit_item'           => __( 'Edytuj Klub', 'mks' ),
			'view_item'           => __( 'Wyświetl klub', 'mks' ),
