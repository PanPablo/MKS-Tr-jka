...
function Contact_init() {
	register_post_type( 'Contact', array(
		'labels'            => array(
			...
			'all_items'           => __( 'Wszystkie', 'mks' ),
			'new_item'            => __( 'Nowy kontakt', 'mks' ),
			'add_new'             => __( 'Dodaj nowy', 'mks' ),
			'add_new_item'        => __( 'Dodaj nowy kontakt', 'mks' ),
			'edit_item'           => __( 'Edytuj kontakt', 'mks' ),
			'view_item'           => __( 'Wyświetl kontakt', 'mks' ),
			'search_items'        => __( 'Szukaj w kontaktach', 'mks' ),
			'not_found'           => __( 'Nie znaleziono kontaktów', 'mks' ),
			'not_found_in_trash'  => __( 'No contacts found in trash', 'mks' ),
			'parent_item_colon'   => __( 'Parent contact', 'mks' ),
			'menu_name'           => __( 'Kontakt', 'mks' ),
		),
		'public'            => true,
		'hierarchical'      => false,
		'show_ui'           => true,
