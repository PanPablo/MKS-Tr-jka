...
function social_init() {
	register_post_type( 'social', array(
		'labels'            => array(
			...
			'all_items'           => __( 'All Socials', 'mks' ),
			'new_item'            => __( 'New social', 'mks' ),
			'add_new'             => __( 'Add New', 'mks' ),
			'add_new_item'        => __( 'Add New social', 'mks' ),
			'edit_item'           => __( 'Edit social', 'mks' ),
			'view_item'           => __( 'View social', 'mks' ),
			'search_items'        => __( 'Search socials', 'mks' ),
